        ...
        return ( <span>
            ...
            <section className="infoCardExpandedColumn" style={{'width':'85%'}}>
                <div className = "biographyName">#{this.props.id} - {this.props.info.firstName} {this.getMove()}<br/>
                    ...
                    <span className="underText">Plassering i fjor: {this.props.info.lastYear} <div id="tweetButton" style={{'display':'inline'}}/></span><br/>
                    <span className="underText">
                        <a href={'https://twitter.com/' + this.props.info.twitterAcnt}>
                            <svg className="svgTwitterLogo"id="Logo_FIXED" data-name="Logo — FIXED" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400" >
                                <rect className="cls-1" fill='#fff'/>
